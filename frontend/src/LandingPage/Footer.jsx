export default function Footer() {
    return (
        <footer className="mt-5 pt-3 border-top bg-body-tertiary">
            <div className="container">
                <div className="row ">
                    <div className="col-lg-4 my-4">
                        <a href="#" ><img src="/media/images/logo.svg" className="my-2" alt="logo" style={{ maxWidth: "160px" }} /></a>
                        <p className="text-body-tertiary fw-semibold" style={{ fontSize: "0.8rem" }}>© 2010 - 2025, Zerodha Broking Ltd. All rights reserved.</p>
                    ...
                    <div className="col-lg-8">
                        <div className="row">
                            <div className="col-lg-3 mt-4 slide">
                                <h4>Account</h4>
                ...
                <div className="container mt-4 foot-p">
                    <p>Zerodha Broking Ltd.: Member of NSE, BSE & MCX SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Zerodha Broking Ltd. SEBI Registration no.: IN-DP-431-2019 Registered Address: Zerodha Broking Ltd., 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@zerodha.com, for DP related to dp@zerodha.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
