  ...
  return (
    <div className="container my-5">
      <div className="row border-bottom">
        <h2 className="text-center my-5 py-md-5">" We pioneered the discount broking model in India.<br />Now, we are breaking ground with our technology. "</h2>
      </div>
      <div className="row my-5 p-1 p-lg-5 about-hero">
        ...
        <div className="col-lg-6 px-lg-5 ">
          ...
          <p><a href="https://rainmatter.com/" className="link-Tag">Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
